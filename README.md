...
### About this fork
This fork adds the ability to show more than 15 processes in the CPU & RAM list in the menu dialog.
...
It's also always shown in the menu bar which lets you always know exactly why your mac is lagging.
...
```bash
brew install --cask maddada/tap/stats
```
